...
public class ModBlocks {
	...
	public static BlockBase forcePlanks = new BlockBase(Material.WOOD, "forcePlanks", "plankWood", SoundType.WOOD)
	...
	public static void registerItemBlocks(IForgeRegistry<Item> registry) {
		registry.registerAll(orePower.createItemBlock(), forceSapling.createItemBlock(), forceLog.createItemBlock(),
				forceLeaves.createItemBlock(), infuser.createItemBlock(), forceFurnace.createItemBlock(),
				forcePlanks.createItemBlock(), forceBrickRed.createItemBlock(), forceBrickYellow.createItemBlock(),
				forceBrickGreen.createItemBlock(), forceBrickBlue.createItemBlock(), forceBrickWhite.createItemBlock(),
				forceBrickBlack.createItemBlock(), forceBrickBrown.createItemBlock(),
				forceBrickOrange.createItemBlock(), forceBrickLightBlue.createItemBlock(),
				forceBrickMagenta.createItemBlock(), forceBrickPink.createItemBlock(),
				forceBrickLightGray.createItemBlock(), forceBrickLime.createItemBlock(),
