...
public class BlockForceFurnace extends BlockContainer {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (worldIn.isRemote) {
			...
			if (tileentity instanceof TileEntityForceFurnace) {
				playerIn.openGui(dartcraftReloaded.instance, DCRGUIHandler.FURNACE, worldIn, pos.getX(), pos.getY(),
						pos.getZ());
	...
	public static void setState(boolean active, World worldIn, BlockPos pos) {
		...
		if (active) {
			worldIn.setBlockState(pos,
					ModBlocks.LIT_FORCEFURNACE.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3); // Blocks.LIT_FURNACE.getDefaultState().withProperty(FACING,
			...
			worldIn.setBlockState(pos,
					ModBlocks.forceFurnace.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3); // Blocks.FURNACE.getDefaultState().withProperty(FACING,
																														// iblockstate.getValue(FACING)),
																														// 3);
			worldIn.setBlockState(pos,
					ModBlocks.forceFurnace.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3); // Blocks.FURNACE.getDefaultState().withProperty(FACING,
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer,
		...
		if (stack.hasDisplayName()) {
			...
			if (tileentity instanceof TileEntityForceFurnace) {
				((TileEntityForceFurnace) tileentity).setCustomInventoryName(stack.getDisplayName());
			}
		}
	}
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
		if (!keepInventory) {
			...
			if (tileentity instanceof TileEntityForceFurnace) {
				InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityForceFurnace) tileentity);
	...
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
		return new ItemStack(ModBlocks.forceFurnace);
	}
