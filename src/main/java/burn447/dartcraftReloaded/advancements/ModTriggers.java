...
public class ModTriggers {
	...
	public static final CustomTrigger[] TRIGGER_ARRAY = new CustomTrigger[] { ADDS_FORCE_MODIFER, ADDS_DAMAGE_MODIFIER,
			ADDS_HEAT_MODIFIER, ADDS_LUMBER_MODIFIER, ADDS_SPEED_MODIFIER };
