...
/**
 * This class is part of my simple custom advancement triggering tutorial. See:
...
public class CustomTrigger implements ICriterionTrigger<CustomTrigger.Instance> {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.minecraft.advancements.ICriterionTrigger#addListener(net.minecraft.
	 ...
	 * 
	 * @see
	 * net.minecraft.advancements.ICriterionTrigger#removeListener(net.minecraft.
	 * advancements.PlayerAdvancements,
	 * net.minecraft.advancements.ICriterionTrigger.Listener)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * net.minecraft.advancements.ICriterionTrigger#removeAllListeners(net.minecraft
	 * .advancements.PlayerAdvancements)
	 */
	@Override
