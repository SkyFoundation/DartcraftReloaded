...
public class TileEntityForceFurnace extends TileEntityLockable implements ITickable, ISidedInventory {
	...
	public static void registerFixesFurnace(DataFixer fixer) {
		fixer.registerWalker(FixTypes.BLOCK_ENTITY,
				new ItemStackDataLists(TileEntityForceFurnace.class, new String[] { "Items" }));
	}
	...
	public static int getItemBurnTime(ItemStack stack) {
		if (stack.getItem() == ModItems.gemForceGem)
			return 1600;
		else
			return 0;
	...
	public boolean isItemValidForSlot(int index, ItemStack stack) {
		if (index == 2) {
			...
			ItemStack itemstack = this.furnaceItemStacks.get(1);
			return isItemFuel(stack) && itemstack.getItem() != Items.BUCKET;
		}
	}
