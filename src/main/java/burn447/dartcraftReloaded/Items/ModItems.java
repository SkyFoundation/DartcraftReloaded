...
public class ModItems {
	...
	public static ItemArmor forceHelmet = new ItemArmor(dartcraftReloaded.forceArmorMaterial, EntityEquipmentSlot.HEAD,
			"force_helmet");
	public static ItemArmor forceChest = new ItemArmor(dartcraftReloaded.forceArmorMaterial, EntityEquipmentSlot.CHEST,
			"force_chest");
	public static ItemArmor forceLegs = new ItemArmor(dartcraftReloaded.forceArmorMaterial, EntityEquipmentSlot.LEGS,
			"force_legs");
	public static ItemArmor forceBoots = new ItemArmor(dartcraftReloaded.forceArmorMaterial, EntityEquipmentSlot.FEET,
			"force_boots");
	...
	public static ItemBase goldenPowerSource = new ItemBase("goldenPowerSource")
	...
	public static ItemForcesMultifunctionalTools ForceMultifunctionalTools = new ItemForcesMultifunctionalTools(
			"force_multifunctional_tools");
	...
	public static void register(IForgeRegistry<Item> registry) {
		registry.registerAll(gemForceGem, ingotForce, nuggetForce, stickForce, cookieFortune, soulWafer, forceHelmet,
				forceChest, forceLegs, forceBoots, forceRod, forceWrench, forcePickaxe, forceAxe, forceSword,
				forceShovel, goldenPowerSource, claw, fortune, forceShears, experienceTome, forceGear, snowCookie,
				forceMitt, magnetGlove, forcePack, forceBelt, bottledWither, inertCore,

				ForceHoe, ForceMultifunctionalTools, ToolsCore);
	}
