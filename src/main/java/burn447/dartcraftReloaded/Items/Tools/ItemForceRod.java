	...
	public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand,
		...
		if (!worldIn.isRemote) {
			if (worldIn.getBlockState(pos.offset(facing)).getBlock().equals(Blocks.FIRE)) {
				...
				List<Entity> list = worldIn.getEntitiesWithinAABB(EntityItem.class,
				...
				for (Entity i : list) {
					if (i instanceof EntityItem) {
						if (((EntityItem) i).getItem().getItem() instanceof ItemInertCore) {
							EntityItem bottledWither = new EntityNonBurnableItem(worldIn, pos.getX(), pos.getY() + 1,
									pos.getZ(),
									new ItemStack(ModItems.bottledWither, ((EntityItem) i).getItem().getCount()));
				...
				for (Entity i : list) {
					if (i instanceof EntityItem) {
						...
						if (((EntityItem) i).getItem().getItem() instanceof ItemArmor) {
							if (((ItemArmor) ((EntityItem) i).getItem()
									.getItem()).armorType == EntityEquipmentSlot.CHEST) {
								if (((ItemArmor) ((EntityItem) i).getItem().getItem())
										.getArmorMaterial() == ItemArmor.ArmorMaterial.IRON) {
									worldIn.removeEntity(i);
									worldIn.spawnEntity(new EntityItem(worldIn, pos.getX(), pos.getY() + 1, pos.getZ(),
											new ItemStack(Items.IRON_INGOT, 6)));
									player.getHeldItem(hand).damageItem(1, player);
								} else if (((ItemArmor) ((EntityItem) i).getItem().getItem())
										.getArmorMaterial() == ItemArmor.ArmorMaterial.GOLD) {
									worldIn.removeEntity(i);
									worldIn.spawnEntity(new EntityItem(worldIn, pos.getX(), pos.getY() + 1, pos.getZ(),
									...
									worldIn.removeEntity(i);
									worldIn.spawnEntity(new EntityItem(worldIn, pos.getX(), pos.getY() + 1, pos.getZ(),
											new ItemStack(ModItems.forceChest, 1)));
									player.getHeldItem(hand).damageItem(1, player);
								}
							}
							if (((ItemArmor) ((EntityItem) i).getItem()
									.getItem()).armorType == EntityEquipmentSlot.LEGS) {
								if (((ItemArmor) ((EntityItem) i).getItem().getItem())
										.getArmorMaterial() == ItemArmor.ArmorMaterial.IRON) {
									worldIn.removeEntity(i);
									worldIn.spawnEntity(new EntityItem(worldIn, pos.getX(), pos.getY() + 1, pos.getZ(),
									...
									worldIn.removeEntity(i);
									worldIn.spawnEntity(new EntityItem(worldIn, pos.getX(), pos.getY() + 1, pos.getZ(),
											new ItemStack(ModItems.forceLegs, 1)));
									player.getHeldItem(hand).damageItem(1, player);
								}
							}
							if (((ItemArmor) ((EntityItem) i).getItem()
									.getItem()).armorType == EntityEquipmentSlot.FEET) {
								if (((ItemArmor) ((EntityItem) i).getItem().getItem())
										.getArmorMaterial() == ItemArmor.ArmorMaterial.IRON) {
									worldIn.removeEntity(i);
									worldIn.spawnEntity(new EntityItem(worldIn, pos.getX(), pos.getY() + 1, pos.getZ(),
									...
									worldIn.removeEntity(i);
									worldIn.spawnEntity(new EntityItem(worldIn, pos.getX(), pos.getY() + 1, pos.getZ(),
											new ItemStack(ModItems.forceBoots, 1)));
									player.getHeldItem(hand).damageItem(1, player);
								}
							}
							if (((ItemArmor) ((EntityItem) i).getItem()
									.getItem()).armorType == EntityEquipmentSlot.HEAD) {
								if (((ItemArmor) ((EntityItem) i).getItem().getItem())
										.getArmorMaterial() == ItemArmor.ArmorMaterial.IRON) {
									worldIn.removeEntity(i);
									worldIn.spawnEntity(new EntityItem(worldIn, pos.getX(), pos.getY() + 1, pos.getZ(),
									...
									worldIn.removeEntity(i);
									worldIn.spawnEntity(new EntityItem(worldIn, pos.getX(), pos.getY() + 1, pos.getZ(),
											new ItemStack(ModItems.forceHelmet, 1)));
									player.getHeldItem(hand).damageItem(1, player);
								}
							}
						}
		...
		if (stack.getCapability(CAPABILITY_FORCEROD, null).getHomeLocation() != null) {
			stack.getCapability(CAPABILITY_FORCEROD, null).teleportPlayerToLocation(player,
					stack.getCapability(CAPABILITY_FORCEROD, null).getHomeLocation());
		}
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
		...
		if (stack.getCapability(CAPABILITY_FORCEROD, null).hasEnderModifier()) {
			if (stack.getCapability(CAPABILITY_FORCEROD, null).getHomeLocation() == null) {
				...
				stack.getCapability(CAPABILITY_FORCEROD, null).teleportPlayerToLocation(playerIn,
						stack.getCapability(CAPABILITY_FORCEROD, null).getHomeLocation());
			}
		}
